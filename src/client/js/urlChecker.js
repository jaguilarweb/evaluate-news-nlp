function checkUrl(inputText) {
    ...
    //Regex reference: https://stackoverflow.com/questions/3809401/what-is-a-good-regular-expression-to-match-a-url
    ...
    const result = regExp.test(inputText) ? true : false;
    return result;
}
